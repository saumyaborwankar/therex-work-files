...
for s in samples:
    ...
    output_file('01_samples/' ,filename, y_reduced_power, sr, '_pwr')
    '''
    output_file('01_samples/' ,filename, y_reduced_centroid_s, sr, '_ctr_s')
    output_file('01_samples/' ,filename, y_reduced_centroid_mb, sr, '_ctr_mb')
    output_file('01_samples/' ,filename, y_reduced_mfcc_up, sr, '_mfcc_up')
    output_file('01_samples/' ,filename, y_reduced_mfcc_down, sr, '_mfcc_down')
    output_file('01_samples/' ,filename, y_reduced_median, sr, '_median')
    output_file('01_samples/' ,filename, y, sr, '_org')'''
